...
export default function Dashboard() {
  ...
  const addScore = async () => {
    ...
    const { error: insertError } = await supabase
      .from("scores")
      .insert({ user_id: userData.user.id, score: Number(score) });
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .divider {
          height: 1px;
          background: linear-gradient(90deg, transparent, #2a3a2a, transparent);
          margin: 4px 0 28px;
        }
        ...
        .draw-btn::before {
          ...
          position: absolute;
          inset: 0;
          background: linear-gradient(135deg, #3a5a3a22, transparent);
          opacity: 0;
        ...
        .draw-pill {
          background: linear-gradient(135deg, #1e2a1e, #161e16);
          border: 1px solid #3a5a3a;
          border-radius: 8px;
          padding: 8px 16px;
          font-size: 15px;
